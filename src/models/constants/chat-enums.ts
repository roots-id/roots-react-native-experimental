export enum MessageType {
  ...
  DID = 'didMsgType',
  PROMPT_NEW_CONTACT = 'rootsAddedNewContact',
  ...
  CRED_DENY = 'CRED_DENY',
  PRISM_DID = 'PRISM_DID',
  LONG_PRISM_DID = 'LONG_PRISM_DID',
  LONG_PRISM_DID_PUBLISH = 'LONG_PRISM_DID_PUBLISH',
  FETCH_PRISM_DID = 'FETCH_PRISM_DID',
  LONG_PRISM_UPDATE = 'LONG_PRISM_UPDATE',
  LONG_PRISM_DIDDOC = 'LONG_PRISM_DIDDOC',
  SHOW_KEYS_PRISM_DID = 'SHOW_KEYS_PRISM_DID',
}
